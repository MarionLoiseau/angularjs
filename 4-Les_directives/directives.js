...
(function(){
  ...
  */
  var angu = angular.module('angularjsExercice1', []);
  ...
  */
  angu.directive('maPremiereDirective', [function(){
  ...
  angu.directive('maDeuxiemeDirective', function(){
  ...
  angu.directive('maTroisiemeDirective', function(){
    return {
      restrict: 'C',
      controller:[function(){
